...
describe('FitBoundsService', function () {
    ...
    beforeEach(fakeAsync(function () {
        loader = { load: jest.fn().mockReturnValue(Promise.resolve()) };
        ...
        TestBed.configureTestingModule({ providers: [{ provide: MapsAPILoader, useValue: loader }, FitBoundsService] });
    ...
    it('should provide all latLng to the bounds', fakeAsync(function () {
        ...
        fitBoundsService.getBounds$().subscribe(success);
        tick(1);
        var latLngs = [{ lat: 2, lng: 2 }, { lat: 3, lng: 3 }, { lat: 4, lng: 4 }];
