...
import { FullscreenControlOptions, LatLngLiteral, MapRestriction, MapTypeControlOptions, MapTypeId, PanControlOptions, RotateControlOptions, ScaleControlOptions, StreetViewControlOptions, ZoomControlOptions } from '../services/google-maps-types';
...
export declare class AgmMap implements OnChanges, OnInit, OnDestroy {
    ...
    maxZoom: number;
    /**
     * The control size for the default map controls. Only governs the controls made by the Maps API
     * itself
     */
    controlSize: number;
    /**
